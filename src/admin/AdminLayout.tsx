      ...
      <div className="lg:pl-64">
        <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-slate-200 bg-white px-4 shadow-sm lg:px-8">
          ...
          <div className="flex items-center gap-3 text-sm">
            <Link
              to="/"
              className="inline-flex items-center gap-2 rounded-md border border-slate-200 px-3 py-2 font-medium text-slate-600 transition hover:bg-slate-100"
            >
        ...
        <main className="min-h-screen px-4 py-6 pb-24 sm:pb-6 lg:px-8">
          <Outlet />
        </main>
      </div>
    </div>
